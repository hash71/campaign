...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        window.initFloatchartDemo2b = function () {
        ...
        if ($("#placeholder6b").length) {
            window.initFloatchartDemo2b();
        }

        //We init function to use it in AJAX Widgets Reload
        var series6 = Math.floor(Math.random() * 6) + 3;

        window.initFloatchartDemo2c = function () {
        ...
        if ($("#placeholder6c").length) {
            window.initFloatchartDemo2c();
        }

        //We init function to use it in AJAX Widgets Reload
        var series6 = Math.floor(Math.random() * 6) + 3;

        window.initFloatchartDemo2d = function () {
        ...
        if ($("#placeholder6d").length) {
            window.initFloatchartDemo2d();
        }
